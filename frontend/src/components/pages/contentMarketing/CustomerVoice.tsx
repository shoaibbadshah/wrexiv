        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote className="text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
              <p>
                {
                  "With the help of GlobalDeel, we were able to find a Japanese CXO. It was the best choice for me, because recruitment platforms are costly and difficult to hire a CXO class of Japanese."
                }
              </p>
            </blockquote>
          </div>
          ...
          <figcaption className="text-base lg:col-start-1 lg:row-start-3">
            <div className="font-semibold text-gray-900">
              Assist in obtaining appointments with distributors and co-founders
              in 3 months
            </div>
            <div className="mt-1 text-gray-500">CEO of Travel startup</div>
          </figcaption>
        </figure>
      </div>
    </section>
