...
export type LanguagesQuery = { __typename?: 'Query', languages: Array<string | null> };

export type MyAgencyUserQueryVariables = Exact<{ [key: string]: never; }>;


export type MyAgencyUserQuery = { __typename?: 'Query', myAgencyUser?: { __typename?: 'AgencyUserType', id: any, name: string, language: string, createdAt: any, updatedAt: any, agencyId: any, userId: any, agency?: { __typename?: 'AgencyType', id: any, name: string, createdAt: any, updatedAt: any } | null } | null };
...
export type CreateAgencyMutation = { __typename?: 'Mutation', createAgency?: { __typename?: 'CreateAgency', success?: boolean | null } | null };
...
export type UpdateMyAgencyMutation = { __typename?: 'Mutation', updateMyAgency?: { __typename?: 'UpdateMyAgency', success?: boolean | null, message?: string | null } | null };
 ...
 * });
 */
export function useMyAgencyUserQuery(baseOptions?: Apollo.QueryHookOptions<MyAgencyUserQuery, MyAgencyUserQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MyAgencyUserQuery, MyAgencyUserQueryVariables>(MyAgencyUserDocument, options);
      }
export function useMyAgencyUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MyAgencyUserQuery, MyAgencyUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MyAgencyUserQuery, MyAgencyUserQueryVariables>(MyAgencyUserDocument, options);
        }
export type MyAgencyUserQueryHookResult = ReturnType<typeof useMyAgencyUserQuery>;
export type MyAgencyUserLazyQueryHookResult = ReturnType<typeof useMyAgencyUserLazyQuery>;
export type MyAgencyUserQueryResult = Apollo.QueryResult<MyAgencyUserQuery, MyAgencyUserQueryVariables>;
...
export const UpdateMyAgencyDocument = gql`
  ...
  updateMyAgency(input: $input) {
    ...
    `;
export type UpdateMyAgencyMutationFn = Apollo.MutationFunction<UpdateMyAgencyMutation, UpdateMyAgencyMutationVariables>;
 ...
 * });
 */
export function useUpdateMyAgencyMutation(baseOptions?: Apollo.MutationHookOptions<UpdateMyAgencyMutation, UpdateMyAgencyMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateMyAgencyMutation, UpdateMyAgencyMutationVariables>(UpdateMyAgencyDocument, options);
      }
export type UpdateMyAgencyMutationHookResult = ReturnType<typeof useUpdateMyAgencyMutation>;
export type UpdateMyAgencyMutationResult = Apollo.MutationResult<UpdateMyAgencyMutation>;
export type UpdateMyAgencyMutationOptions = Apollo.BaseMutationOptions<UpdateMyAgencyMutation, UpdateMyAgencyMutationVariables>;
