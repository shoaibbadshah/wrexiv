...
resource "google_cloud_run_v2_service" "api" {
  ...
  depends_on = [google_redis_instance.celery_broker]
}

# resource "google_cloud_run_v2_service" "celery" {
#   name           = "globaltalentdb-celery"
#   location       = "asia-northeast1"
#   ingress        = "INGRESS_TRAFFIC_ALL"
#   client         = "gcloud"
#   client_version = "426.0.0"
...
#     }
#     containers {
#       image = "asia-northeast1-docker.pkg.dev/globaltalentdb/globaltalentdb/globaltalentdb-celery"
#       volume_mounts {
#         mount_path = "/cloudsql"
#         name       = "cloudsql"
#       }
